...
class AddBeneficiaryAdult extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nationalId: '',
  ...
  handleNext2() {
    ...
    const member = {
      ...
      msisdn: phoneNumber,
      relationship: MEMBER_TYPES.BENEFICIARY_ADULT,
    }
    ...
    return (<>
      <ValidatorForm onSubmit={this.handleNext2.bind(this)} key={1} style={{ padding: '5%' }}>
        ...
        <TextValidator label={"Date of birth"}
          ...
          validators={['required']}
          errorMessages='please select dob'
        ...
        <button className="next-buttons another" type='submit' onClick={() => { this.setState({ addAnother: true }); }}>Add another Beneficiary</button>
        <button className="next-buttons view-members-btn" style={{ background: 'orange', color: 'black' }} onClick={this.viewMembers.bind(this)}>View members</button>
      </ValidatorForm>
    </>
    );
  }
...
export default AddBeneficiaryAdult;
