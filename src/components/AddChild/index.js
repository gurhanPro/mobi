...
class AddChild extends Component {
  ...
  handleNext2() {
    ...
    const member = {
      ...
      msisdn: phoneNumber,
      relationship: MEMBER_TYPES.CHILD,
    }
  ...
  validateDob(rawDate) {
    ...
    return dobInDays >=30 && dobInYears <= 25
  }
    ...
    return (<>
      <ValidatorForm onSubmit={this.handleNext2.bind(this)} key={1} style={{ padding: '5%' }}>
        ...
        <TextValidator label={"Date of birth"}
          ...
          errorMessages='please enter a valid dob, must be 30 days to 25 years'
        ...
        <button className="next-buttons another" type='submit' onClick={() => { this.setState({ addAnother: true }); }}>Add another child</button>
      </ValidatorForm>
    </>
    );
  }
